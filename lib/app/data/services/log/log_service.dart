...
class LogService {
  ...
  static Future<File> _localFile() async {
    ...
    AppConst.LOG_FILE_PATH = fullPath;
  ...
  static Future<void> setLogValue(bool value) async {
    StorageService.setLogEnabled(value);
  }
  ...
  static Future<String> getVersionName() async {
    ...
    var versionInfo =
        "$version.${AppConst.APP_RELEASE_ID}_${AppConst.APP_RELEASE_DATE}";
    return versionInfo;
  }
  ...
  static Future<void> initLogs() async {
    ...
    try {
      ...
      AppConst.isLogEnabled = isTraceOn;
      ...
      if (isExists) {
        ...
        await file.writeAsString(
          'Axpert Android Log File\n',
          mode: FileMode.write,
          flush: true,
        );
        await file.writeAsString(
          'App Version: ${await getVersionName()}\n',
  ...
  static Future<void> writeOnConsole({String message = ""}) async {
    return;
  ...
  static void printLongString(String text) {
    final RegExp pattern = RegExp(
      '.{1,800}',
    ); // Slices into 800-character chunks
    pattern
        .allMatches(text)
  ...
  static Future<void> writeLog({String message = ""}) async {
    ...
    if (AppConst.isLogEnabled) {
      final file = await _localFile();
      var formatedDateTime = DateFormat(
        "dd-MMM-yyyy HH:mm:ss:SSS",
      ).format(DateTime.now());
      try {
        await file.writeAsString(
          '$formatedDateTime: $message\n',
          mode: FileMode.append,
        );
      } catch (e) {}
    }
  ...
  static Future<void> clearLog() async {
    print("offline_trace Clear log called");
    ...
    try {
      ...
      print("offline_trace Clear log error $e");
      log("Clear log error $e", name: 'offline_trace');
    }
  }

  // Experimental------------->
  static Future<void> writeLogAdv({
