...
import '../../db/db.dart';
import '../controller/offline_audit_log_controller.dart';
        ...
        return CustomScrollView(
          slivers: [
            SliverPersistentHeader(
              floating: true,
              delegate: _FilterHeaderDelegate(child: _FilterPanel(c: c)),
            ),
...
class _AuditDropdown<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final dropdown = Container(
      height: 34,
      padding: EdgeInsets.only(left: leadingIcon != null ? 6 : 10, right: 10),
      decoration: BoxDecoration(
        color: Colors.white,
...
class _LogTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color tileSoft = isError
        ? AuditColors.redSoft
        : AuditColors.greenSoft;
