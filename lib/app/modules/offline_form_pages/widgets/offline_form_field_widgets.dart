...
class OfflineFormField extends GetView<OfflineFormController> {
  ...
  Widget _checkBox() {
    return CheckboxListTile(
      ...
      title: Text(field.fldCaption, style: GoogleFonts.poppins(fontSize: 13)),
      onChanged: field.readOnly
          ? null
          : (v) => controller.updateFieldValue(field, v),
    );
  }
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              if (field.isCamera)
                ListTile(
                  leading: Icon(Icons.camera_alt, color: AppColors.AXMDark),
                  title: Text(
                    'Camera',
