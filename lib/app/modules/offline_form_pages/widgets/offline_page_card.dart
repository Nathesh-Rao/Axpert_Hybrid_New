              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Spacer(),
                    if (page.attachments)
                      Icon(Icons.attach_file, size: 16, color: baseColor),
                  ],
                ),
              ),
            ),
          ...
          children: [
            ...
            if (page.attachments)
              Positioned(
                top: 10,
                right: 10,
                child: Icon(Icons.attach_file, size: 18, color: baseColor),
              ),
          ],
        ),
      ),
        ...
        child: Stack(
          children: [
            ...
            Align(
              ...
              child: Opacity(
                opacity: 0.4,
                child: Image.asset("assets/images/content2.png", width: 100),
              ),
            ),
          ],
        ),
...
class OfflinePageCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final _GradientSet gradient = useColoredTile
        ...
        child: Stack(
          children: [
            ...
            Align(
              ...
              child: Opacity(
                opacity: 0.4,
                child: Image.asset("assets/images/content.png", width: 100),
              ),
            ),
...
class _WavePainter extends CustomPainter {
  ...
  _WavePainter({required this.color, this.offset = 0});
...
const _defaultGray = _GradientSet([Color(0xFF546E7A), Color(0xFF37474F)]);
