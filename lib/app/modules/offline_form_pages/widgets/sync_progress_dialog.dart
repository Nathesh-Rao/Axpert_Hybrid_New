      ...
      if (progressModel.isCompletedWithError.value) {
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            // border: Border.all(color: AppColors.AXMGray),
      ...
      () => (progressModel.successCount != 0 || progressModel.failureCount != 0)
          ? Container(
              ...
              child: Row(
                ...
                children: [
                  _statItem(
                    progressModel.successCount,
                    "Success",
                    const Color(0xFF16A34A),
                  ),
                  _statItem(
                    progressModel.failureCount,
                    "Failed",
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if (progressModel.isSessionError.value) {
                          WebViewController lc = Get.find();
                          lc.showSessionExpiredDialog();
                        }
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: AppColors.AXMDark,
                        elevation: 0,
                        padding: const EdgeInsets.symmetric(vertical: 14),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(12),
