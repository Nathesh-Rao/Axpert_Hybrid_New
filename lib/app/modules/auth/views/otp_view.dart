...
//                     Obx(
//                       () => _projectNameWidget(
//                         projectName: authController.currentProjectName.value,
//                       ),
//                     ),
//                     Obx(
//                       () => WidgetOtpTextField(
...
//     _isTimerActive = true;
//     _remaining = Duration(
//       minutes: int.parse(authController.otpExpiryTime.value),
//     );
                  ...
                  children: [
                    ...
                    Obx(
                      () => WidgetOtpTextField(
                        ...
                        otpLength: int.parse(controller.otpChars.value),
                        errorText: controller.otpErrorText.value,
                        onCompleted: () => controller.callVerifyOTP(),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Obx(
                            () => InkWell(
                              onTap: controller.isOtpTimerActive
                                  ? null
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.manrope(
                                  fontWeight: FontWeight.w700,
                                  fontSize: 13,
                                  color: controller.isOtpTimerActive
                                      ? Colors.grey
                                      : (controller.selectedColor.value ??
                                            AppColors.darkBlue),
                                ),
                    ...
                    Obx(
                      () => WidgetLoginButton(
                        ...
                        onPressed: () => controller.callVerifyOTP(),
                      ),
                    ),
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        return Text(
                          "Version:${snapshot.data}_${AppConst.APP_RELEASE_DATE}",
                          style: GoogleFonts.poppins(
